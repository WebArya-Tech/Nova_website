...
import { Card, Badge, Spinner, Button, TextArea, Input, Pagination, TagBadge } from '../ui';
            ...
            <div className="mb-8">
                {onBack && (
                    <button onClick={onBack}
                        className="flex items-center gap-1.5 text-sm font-semibold mb-4 hover:opacity-75 transition"
                        style={{ color: '#196d83' }}>
            ...
            <div className="flex flex-wrap gap-2 mb-6">
                {['', 'PENDING', 'PUBLISHED', 'REJECTED', 'DRAFT'].map((s) => (
                    <button key={s} onClick={() => handleStatusFilter(s)}
                        ...
                        style={statusFilter === s ? { backgroundColor: '#196d83', color: 'white' } : {}}>
                        {s || 'All'}
                    </button>
                ))}
            </div>
                        ...
                        <div className="flex items-start justify-between px-5 py-4 border-b border-border-primary shrink-0">
                            <div className="min-w-0 pr-3">
                                <div className="flex items-center gap-2 mb-0.5">
                                    <MessageSquare className="w-4 h-4 shrink-0" style={{ color: '#196d83' }} />

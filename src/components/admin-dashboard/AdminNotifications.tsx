...
export default function AdminNotifications() {
  ...
  const getPriorityBadge = (priority) => {
    switch (priority) {
      ...
      case 'normal':
        return <span className="px-3 py-1 rounded-full text-xs font-bold" style={{ backgroundColor: '#e8f4f8', color: '#196d83' }}>🔵 Normal</span>
      case 'low':
    ...
    return (
      <div className="flex items-center justify-center py-12">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg font-semibold" style={{ color: '#196d83' }}>Loading notifications...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h2 className="text-3xl font-bold" style={{ color: '#196d83' }}>🔔 Notification Management</h2>
      ...
      <div className="bg-white rounded-xl shadow-md p-4 flex flex-wrap gap-2">
        {['all', 'sent', 'scheduled', 'reminder', 'assignment', 'info', 'announcement'].map(f => (
          <button
            ...
            style={{ backgroundColor: filter === f ? '#196d83' : 'transparent' }}
          >
      ...
      <div className="bg-white rounded-xl shadow-md p-6">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-2xl font-bold" style={{ color: '#196d83' }}>
        ...
        {showForm && (
          <form onSubmit={handleSubmit} className="space-y-4 mb-8 p-6 rounded-lg" style={{ backgroundColor: '#f8f9fa' }}>
            <div>
              ...
              <input
                ...
                style={{ borderColor: '#196d83', backgroundColor: 'white' }}
                required
              />
            </div>
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <h4 className="text-lg font-bold" style={{ color: '#196d83' }}>
                        {notification.title}
                      </h4>

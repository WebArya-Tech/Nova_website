...
const DEFAULT_ANNOUNCEMENTS = [
  { id: 1, title: 'Welcome to Nova Tuitions!', message: 'We are glad to have you on board. Explore your dashboard to access courses, homework and more.', category: 'general', priority: 'medium', createdAt: '2026-02-20' },
...
export default function AnnouncementManagement() {
  ...
  useEffect(() => { localStorage.setItem('nova_announcements', JSON.stringify(announcements)) }, [announcements])
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-3xl font-bold" style={{ color: '#196d83' }}>📢 Announcement Management</h2>
        <p className="text-gray-600 mt-2">Create and publish announcements</p>
      </div>
            ...
            {announcements.map((a) => (
              <li key={a.id} className="py-4 flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                ...
                <div className="flex gap-2 mt-2 md:mt-0">
                  <button
                    className="px-3 py-1 rounded bg-[#196d83] text-white"

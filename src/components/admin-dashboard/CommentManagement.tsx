                ...
                <div className="bg-white shadow-sm sticky top-18 z-40 px-6 py-4 flex items-center justify-between gap-4 flex-wrap">
                    <div className="flex items-center gap-3 min-w-0">
                        <button onClick={closeBlog}
                            ...
                            <ArrowLeft className="w-5 h-5" style={{ color: '#196d83' }} />
                        </button>
                        <div className="min-w-0">
                            <div className="flex items-center gap-2 flex-wrap">
                                <MessageSquare className="w-5 h-5 shrink-0" style={{ color: '#196d83' }} />
                                <h1 className="text-base font-bold truncate max-w-sm" style={{ color: '#196d83' }}>
                                    {selectedBlog.title}
                                </h1>
                    ...
                    <button onClick={() => fetchComments(selectedBlog.id, commentPage)}
                        className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium border border-gray-200 hover:bg-gray-50 transition shrink-0"
                        style={{ color: '#196d83' }}>
                    ...
                    {commentsLoading ? (
                        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 py-20 text-center">
                            <div className="inline-block animate-spin rounded-full h-10 w-10 border-t-2 border-b-2"
                                style={{ borderColor: '#196d83', borderTopColor: '#ddaa2c' }} />
                    ...
                    {commentPagination.totalPages > 1 && (
                        <div className="mt-6 flex items-center justify-between">
                            <button
                                ...
                                className="flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium border border-gray-200 hover:bg-gray-50 transition disabled:opacity-40"
                                style={{ color: '#196d83' }}>
        ...
        <div className="min-h-screen" style={{ backgroundColor: '#f8f9fa' }}>
            ...
            <div className="bg-white shadow-sm sticky top-18 z-40 px-6 py-4 flex items-center justify-between gap-4 flex-wrap">
                <div className="flex items-center gap-3">
                    ...
                    <MessageSquare className="w-6 h-6 shrink-0" style={{ color: '#196d83' }} />
                    <div>
                        <h1 className="text-xl font-bold" style={{ color: '#196d83' }}>Comment Management</h1>
                        <p className="text-xs text-gray-400">Select a blog to view and manage its comments</p>
                    </div>
                </div>
                <button onClick={() => fetchBlogs(blogPage)}
                    className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium border border-gray-200 hover:bg-gray-50 transition"
                    style={{ color: '#196d83' }}>
                    <RefreshCw className="w-4 h-4" /> Refresh
                </button>
            </div>
            ...
            <div className="max-w-5xl mx-auto px-6 py-8">
                ...
                <div className="relative mb-6">
                    ...
                    <input type="text" placeholder="Search blogs by title or author..."
                        ...
                        className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-200 bg-white text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-[#196d83] focus:border-transparent" />
                </div>
                            ...
                            {filteredBlogs.map((blog) => (
                                <button key={blog.id} onClick={() => openBlog(blog)}
                                    ...
                                    <div className="col-span-1 md:col-span-6 flex items-center gap-3 min-w-0">
                                        ...
                                        <span className="text-sm font-semibold text-gray-800 truncate group-hover:text-[#196d83] transition">
                                            {blog.title}
                                        </span>
                                    </div>
                                    ...
                                    <div className="col-span-1 md:col-span-2 flex items-center justify-center gap-1.5">
                                        ...
                                        <span className={`text-sm font-bold ${(blog.commentsCount || 0) > 0 ? 'text-[#196d83]' : 'text-gray-300'}`}>
                                            {blog.commentsCount ?? 0}
                                        </span>
                                        <ChevronRight className="w-4 h-4 text-gray-300 group-hover:text-[#196d83] transition ml-1" />
                                    </div>
                                </button>
                            ))}
                        </div>

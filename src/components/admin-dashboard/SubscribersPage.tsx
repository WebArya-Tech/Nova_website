        ...
        <div className="max-w-6xl mx-auto px-6 py-10">
            {onBack && (
                <button onClick={onBack}
                    className="flex items-center gap-2 text-sm font-semibold mb-4 hover:opacity-75 transition"
                    style={{ color: '#196d83' }}>
            ...
            <div className="mb-8 flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-bold mb-2 flex items-center gap-3" style={{ color: '#196d83' }}>
                ...
                <div className="text-right">
                    <p className="text-3xl font-bold" style={{ color: '#196d83' }}>{pagination.totalElements}</p>
            ...
            <div className="flex gap-2 mb-6">
                {[
                    ...
                    <button
                        ...
                        style={statusFilter === f.value ? { backgroundColor: '#196d83' } : {}}
                    >
                        {f.label}
                    </button>
                ))}
                    ...
                    {subscribers.map((sub) => (
                        <Card key={sub.id} className="p-4 grid grid-cols-1 md:grid-cols-12 gap-3 items-center">
                            ...
                            <div className="col-span-1 md:col-span-5 flex items-center gap-3">
                                ...
                                <p className="text-sm truncate" style={{ color: '#196d83' }}>{sub.email}</p>
                            </div>

...
export default function BlogDashboard({ setCurrentView }) {
    ...
    const statCards = [
        { label: 'Total Blogs',    value: stats.total,       icon: FileText,    color: '#196d83', bg: '#f0f7fa' },
    ...
    return (
        <div className="w-full px-4 md:px-8 py-8">
            <h1 className="text-3xl font-bold mb-1" style={{ color: '#196d83' }}>Blog Dashboard</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <button onClick={() => setCurrentView('blogs')}
                    className="bg-white rounded-xl shadow-md p-6 text-left hover:shadow-xl transition-all border-2 border-transparent hover:border-[#196d83] group">
                    <div className="flex items-start gap-4">
                        <div className="p-3 rounded-xl" style={{ backgroundColor: '#f0f7fa' }}>
                            <Eye className="w-7 h-7" style={{ color: '#196d83' }} />
                        </div>
                        <div>
                            <h2 className="text-lg font-bold mb-1" style={{ color: '#196d83' }}>Blog Moderation</h2>

...
export default function AdminProfile({ adminData }) {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h2 className="text-3xl font-bold" style={{ color: '#196d83' }}>👤 Admin Profile</h2>
        <p className="text-gray-600 mt-2">Manage your admin account and settings</p>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-md p-6 md:p-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-8 pb-8 border-b-2" style={{ borderColor: '#f0f0f0' }}>
          <div className="flex items-center gap-6">
            ...
            <div className="relative group">
              {profileImage ? (
                ...
                <div
                  className="w-24 h-24 rounded-full flex items-center justify-center font-bold text-white text-4xl shadow-lg"
            ...
            <div>
              <h3 className="text-2xl font-bold" style={{ color: '#196d83' }}>{adminData.name}</h3>
          ...
          <button
            ...
            style={{ backgroundColor: isEditing ? '#dc3545' : '#196d83' }}
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                style={{ 
                  borderColor: isEditing ? '#196d83' : '#e0e0e0',
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <Phone size={20} className="text-gray-600" style={{ color: '#196d83' }} />
                <input
                  type="tel"
                  name="phone"
            ...
            <div className="md:col-span-2">
              ...
              <div className="flex items-start gap-2">
                <MapPin size={20} className="text-gray-600 mt-3" style={{ color: '#196d83' }} />
                <input
                  type="text"
                  name="address"
      ...
      {/* Security Section */}
      <div className="bg-white rounded-xl shadow-md p-6 md:p-8">
        <h3 className="text-xl font-bold mb-6" style={{ color: '#196d83' }}>
          🔒 Security Settings
        </h3>
        ...
        <div className="space-y-4">
          <button
            ...
            className="w-full px-6 py-3 rounded-lg text-white font-semibold flex items-center justify-between hover:opacity-90 transition-all"
            style={{ backgroundColor: '#196d83' }}
          >
          ...
          {showChangePasswordForm && (
            <div className="mt-4 p-6 bg-gray-50 rounded-lg border-2" style={{ borderColor: '#196d83' }}>
              <div className="space-y-4">
                {/* Current Password */}
                <div>

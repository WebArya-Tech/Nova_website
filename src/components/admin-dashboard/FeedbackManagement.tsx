...
const loadFeedback = () => {
  try {
    const saved = JSON.parse(localStorage.getItem('nova_feedback') || 'null')
...
export default function FeedbackManagement() {
  ...
  const saveFeedback = (updated) => {
    ...
    localStorage.setItem('nova_feedback', JSON.stringify(updated))
  }
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-3xl font-bold" style={{ color: '#196d83' }}>⭐ Feedback & Reviews Management</h2>
        <p className="text-gray-600 mt-2">View and respond to student feedback</p>
      </div>

// Migrated to AskQuestion.tsx
export { default } from './AskQuestion.tsx'
...
export default function AskQuestion() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h2 className="text-3xl font-bold" style={{ color: '#196d83' }}>Ask a Question</h2>
        <p className="text-gray-600 mt-2">Get AI-powered answers reviewed by expert tutors</p>
      </div>

      {/* Ask New Question Form */}
      <div className="bg-white rounded-xl shadow-md p-6">
        <h3 className="text-2xl font-bold mb-6" style={{ color: '#196d83' }}>Post Your Question</h3>
      ...
      {/* My Questions */}
      <div className="bg-white rounded-xl shadow-md p-6">
        <h3 className="text-2xl font-bold mb-6" style={{ color: '#196d83' }}>My Questions</h3>
        <div className="space-y-4">
          {paginatedQuestions.map((q) => (
            ...
            >
              ...
              {q.answer && (
                <div className="mt-4 p-4 rounded-lg" style={{ backgroundColor: '#e8f5f0' }}>
                  <p className="font-semibold mb-2" style={{ color: '#196d83' }}>Answer:</p>

...
export default function SupportHelp() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h2 className="text-3xl font-bold text-primary">Support & Help</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-md p-6 border-l-4" style={{ borderLeftColor: '#ddaa2c' }}>
          <h3 className="text-xl font-bold mb-2 text-accent">Email Us</h3>
          <p className="text-gray-700 mb-3">novatuitions@ixpoe.com</p>
      ...
      <div className="bg-white rounded-xl shadow-md p-6">
        <h3 className="text-2xl font-bold mb-6 text-primary">My Support Tickets</h3>
        ...
        {ticketsTotalPages > 1 && (
          <div className="flex items-center justify-center gap-2 mt-6">
            <button
              ...
              style={{ 
                backgroundColor: ticketsPage === 1 ? '#e0e0e0' : '#196d83',
            ...
            {[...Array(ticketsTotalPages)].map((_, index) => (
              <button
                ...
                style={{
                  backgroundColor: ticketsPage === index + 1 ? '#196d83' : 'white',
                  color: ticketsPage === index + 1 ? 'white' : '#196d83',
            ...
            <button
              ...
              className="px-4 py-2 rounded-lg font-semibold transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              style={{ 
                backgroundColor: ticketsPage === ticketsTotalPages ? '#e0e0e0' : '#196d83',
      ...
      <div className="bg-white rounded-xl shadow-md p-6">
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          <button
            ...
            style={{ backgroundColor: selectedCategory === 'all' ? '#196d83' : 'transparent', border: '2px solid #196d83' }}
          >
            All
          </button>
          <button
            ...
            style={{ backgroundColor: selectedCategory === 'account' ? '#ddaa2c' : 'transparent', border: '2px solid #ddaa2c' }}
          >
            Account
          </button>
          <button
        ...
        <div className="space-y-4">
          {paginatedFaqs.map((faq, index) => (
            <details
              key={index}
              className="p-4 rounded-lg cursor-pointer hover:shadow-md transition-all border border-gray-100"
            >
        ...
        {faqsTotalPages > 1 && (
          <div className="flex items-center justify-center gap-2 mt-6">
            <button
              ...
              className="px-4 py-2 rounded-lg font-semibold transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              style={{ 
                backgroundColor: faqsPage === 1 ? '#e0e0e0' : '#196d83',
            ...
            {[...Array(faqsTotalPages)].map((_, index) => (
              <button
                ...
                className="px-4 py-2 rounded-lg font-semibold transition-all"
                style={{
                  backgroundColor: faqsPage === index + 1 ? '#196d83' : 'white',
                  color: faqsPage === index + 1 ? 'white' : '#196d83',
                  border: '2px solid #196d83'
                }}
              >
                {index + 1}
            ...
            <button
              ...
              className="px-4 py-2 rounded-lg font-semibold transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              style={{ 
                backgroundColor: faqsPage === faqsTotalPages ? '#e0e0e0' : '#196d83',

...
export default function MyProfile({ studentData }) {
  ...
  const [formData, setFormData] = useState({
    ...
    guardianName: 'Mr. Suresh Yadav',
    guardianPhone: '+91 73489 56285',
    educationLevel: 'Class 11',
    institution: 'Nova Tuitions Online',
    semester: '2025-26',
    major: 'Science (PCM)'
  })
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        {!isEditing ? (
          <button
            ...
            className="px-6 py-3 rounded-lg text-white font-semibold shadow-md hover:opacity-90 transition-all bg-accent"
          >
            Edit Profile
          </button>
        ) : (
          <div className="flex gap-3">
            <button
              onClick={handleSave}
              className="px-6 py-3 rounded-lg text-white font-semibold shadow-md hover:opacity-90 transition-all"
            ...
            <button
              ...
              className="px-6 py-3 rounded-lg font-semibold shadow-md hover:bg-gray-100 transition-all border-2"
      ...
      <div className="bg-white rounded-xl shadow-md p-8">
        <div className="flex items-start gap-6 mb-8">
          <div
            className="w-32 h-32 rounded-full flex items-center justify-center font-black text-white text-5xl border-4 shadow-lg"
            style={{ backgroundColor: '#196d83', borderColor: '#ddaa2c' }}
          >
          ...
          <div className="flex-1">
            ...
            <div className="flex gap-2 mt-4">
              <span className="px-4 py-2 rounded-full text-sm font-bold text-white bg-primary">
                {formData.educationLevel}
              </span>
              <span className="px-4 py-2 rounded-full text-sm font-bold text-white bg-accent">
                {formData.semester}
              </span>
            </div>
          </div>
          <button 
            ...
            className="px-4 py-2 rounded-lg text-white font-semibold hover:opacity-90 transition-all bg-primary"
          >
            Change Photo
          </button>
        </div>
        ...
        <div className="border-t-2 pt-6" style={{ borderColor: '#f0f0f0' }}>
          <h4 className="text-xl font-bold mb-6 text-primary">Personal Information</h4>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              {isEditing ? (
                ...
                <p className="px-4 py-3 rounded-lg bg-gray-50 text-gray-800">{formData.name}</p>
              )}
            </div>
            ...
            <div>
              ...
              {isEditing ? (
                ...
                <p className="px-4 py-3 rounded-lg bg-gray-50 text-gray-800">{formData.email}</p>
              )}
            </div>
            ...
            <div>
              ...
              {isEditing ? (
                ...
                <p className="px-4 py-3 rounded-lg bg-gray-50 text-gray-800">{formData.phone}</p>
              )}
            </div>
            ...
            <div>
              ...
              {isEditing ? (
                ...
                <p className="px-4 py-3 rounded-lg bg-gray-50 text-gray-800">{formData.dateOfBirth}</p>
              )}
            </div>
            ...
            <div className="md:col-span-2">
              ...
              {isEditing ? (
                ...
                <p className="px-4 py-3 rounded-lg bg-gray-50 text-gray-800">{formData.address}</p>
              )}
            </div>
            ...
            <div>
              ...
              {isEditing ? (
                ...
                <p className="px-4 py-3 rounded-lg bg-gray-50 text-gray-800">{formData.city}</p>
              )}
            </div>
            ...
            <div>
              ...
              {isEditing ? (
                ...
                <p className="px-4 py-3 rounded-lg bg-gray-50 text-gray-800">{formData.state}</p>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="border-t-2 pt-6 mt-8" style={{ borderColor: '#f0f0f0' }}>
          <h4 className="text-xl font-bold mb-6 text-primary">Academic Information</h4>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              {isEditing ? (
                ...
                <p className="px-4 py-3 rounded-lg bg-gray-50 text-gray-800">{formData.educationLevel}</p>
              )}
            </div>
            ...
            <div>
              ...
              {isEditing ? (
                ...
                <p className="px-4 py-3 rounded-lg bg-gray-50 text-gray-800">{formData.institution}</p>
              )}
            </div>
            ...
            <div>
              ...
              {isEditing ? (
                ...
                <p className="px-4 py-3 rounded-lg bg-gray-50 text-gray-800">{formData.semester}</p>
              )}
            </div>
            ...
            <div>
              ...
              {isEditing ? (
                ...
                <p className="px-4 py-3 rounded-lg bg-gray-50 text-gray-800">{formData.major}</p>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="border-t-2 pt-6 mt-8" style={{ borderColor: '#f0f0f0' }}>
          <h4 className="text-xl font-bold mb-6 text-primary">Guardian Information</h4>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              {isEditing ? (
                ...
                <p className="px-4 py-3 rounded-lg bg-gray-50 text-gray-800">{formData.guardianName}</p>
              )}
            </div>
            ...
            <div>
              ...
              {isEditing ? (
                ...
                <p className="px-4 py-3 rounded-lg bg-gray-50 text-gray-800">{formData.guardianPhone}</p>
              )}
            </div>
          </div>
        </div>
      ...
      <div className="bg-white rounded-xl shadow-md p-6">
        <h4 className="text-xl font-bold mb-6 text-primary">Account Settings</h4>
        <div className="space-y-4">
          ...
          <button 
            ...
            className="w-full px-6 py-4 rounded-lg text-left font-semibold hover:shadow-md transition-all border-2" 
            style={{ borderColor: '#ddaa2c', color: '#ddaa2c' }}
          >
      ...
      {showNotificationModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" onClick={() => setShowNotificationModal(false)}>
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-md mx-4 p-6" onClick={(e) => e.stopPropagation()}>
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-2xl font-bold text-primary">Notification Preferences</h3>
              <button

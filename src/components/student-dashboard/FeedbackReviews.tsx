  ...
  const myReviews = [
    {
      ...
      rating: 5,
      feedback: 'Ms. Ramya explains concepts with great clarity. The practice sets are very helpful!',
      date: 'Mar 15, 2026',
  ...
  const allReviews = [
    {
      ...
      rating: 5,
      feedback: 'B. Aishwarya explains organic reactions so well. Highly recommended!',
      date: '2 days ago'
    },
    {
      id: 2,
      ...
      rating: 5,
      feedback: 'Best online tuition for CBSE. Very disciplined and structured teaching.',
      date: '3 days ago'
    },
    {
      id: 3,
    ...
    },
    {
      ...
      course: 'Physics - Mechanics',
      rating: 5,
      feedback: 'The live classes are interactive and engaging. Mr. Ram explains Newton\'s laws brilliantly!',
      date: '1 week ago'
    }
  ]
      ...
      <div className="flex gap-1">
        {[1, 2, 3, 4, 5].map((star) => (
          <span
            key={star}
            className="text-2xl"
            style={{ color: star <= rating ? '#ddaa2c' : '#e0e0e0' }}
          >
            ★
          </span>
        ))}
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-3xl font-bold text-primary">Feedback & Reviews</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-md p-6 border-l-4" style={{ borderLeftColor: '#196d83' }}>
          ...
          <p className="text-4xl font-bold text-primary">{allReviews.length + myReviews.length}</p>
        </div>
      ...
      <div className="bg-white rounded-xl shadow-md p-6">
        <h3 className="text-2xl font-bold mb-6 text-primary">My Reviews</h3>
        <div className="space-y-4">
          {paginatedMyReviews.map((review) => (
            <div
              key={review.id}
              className="p-5 rounded-lg border-l-4"
              style={{ backgroundColor: 'white', borderLeftColor: '#ddaa2c' }}
            >
              <div className="flex items-start justify-between mb-3">
                <div className="flex-1">
                  <h4 className="font-bold text-lg mb-2">{review.course}</h4>
                  {renderStars(review.rating)}
                  <span className="px-3 py-1 rounded-full text-xs font-bold mt-2 inline-block" style={{ backgroundColor: '#196d83', color: 'white' }}>
                    {review.category}
                  </span>
                </div>
              ...
              {review.response && (
                <div className="mt-3 p-3 rounded-lg border border-gray-100">
                  <p className="text-sm font-semibold mb-1 text-primary">Admin Response:</p>
        ...
        {myReviewsTotalPages > 1 && (
          <div className="flex items-center justify-center gap-2 mt-6">
            <button
              ...
              style={{ 
                backgroundColor: myReviewsPage === 1 ? '#e0e0e0' : '#196d83',
            ...
            {[...Array(myReviewsTotalPages)].map((_, index) => (
              <button
                ...
                style={{
                  backgroundColor: myReviewsPage === index + 1 ? '#196d83' : 'white',
                  color: myReviewsPage === index + 1 ? 'white' : '#196d83',
            ...
            <button
              ...
              className="px-4 py-2 rounded-lg font-semibold transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              style={{ 
                backgroundColor: myReviewsPage === myReviewsTotalPages ? '#e0e0e0' : '#196d83',
      ...
      {/* All Reviews */}
      <div className="bg-white rounded-xl shadow-md p-6">
        <h3 className="text-2xl font-bold mb-6 text-primary">Student Reviews</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {paginatedAllReviews.map((review) => (
            ...
            >
              <div className="flex items-start justify-between mb-3">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    <div
                      className="w-10 h-10 rounded-full flex items-center justify-center font-bold text-white bg-primary"
                    >
              ...
              <p className="text-sm font-semibold mb-2 text-primary">{review.course}</p>
        ...
        {allReviewsTotalPages > 1 && (
          <div className="flex items-center justify-center gap-2 mt-6">
            <button
              ...
              className="px-4 py-2 rounded-lg font-semibold transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              style={{ 
                backgroundColor: allReviewsPage === 1 ? '#e0e0e0' : '#196d83',
            ...
            {[...Array(allReviewsTotalPages)].map((_, index) => (
              <button
                ...
                className="px-4 py-2 rounded-lg font-semibold transition-all"
                style={{
                  backgroundColor: allReviewsPage === index + 1 ? '#196d83' : 'white',
                  color: allReviewsPage === index + 1 ? 'white' : '#196d83',
                  border: '2px solid #196d83'
                }}
              >
                {index + 1}
            ...
            <button
              ...
              className="px-4 py-2 rounded-lg font-semibold transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              style={{ 
                backgroundColor: allReviewsPage === allReviewsTotalPages ? '#e0e0e0' : '#196d83',
      ...
      {showFeedbackForm && (
        ...
        >
          ...
          >
            <h2 className="text-2xl font-bold mb-6 text-primary">Write Your Review</h2>
                ...
                <div className="flex gap-2">
                  {[1, 2, 3, 4, 5].map((star) => (
                    <button
                      ...
                      style={{ color: star <= feedbackForm.rating ? '#ddaa2c' : '#e0e0e0' }}
                    >
                      ★
                    </button>
                  ))}
